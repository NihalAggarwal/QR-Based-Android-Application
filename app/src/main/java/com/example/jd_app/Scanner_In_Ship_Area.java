...
public class Scanner_In_Ship_Area extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanner_in_ship_area);
                    ...
                    public void run() {
                        try {
                            ...
                            if(decrypt.equals(check)){
                                ...
                                Toast.makeText(Scanner_In_Ship_Area.this, "Scan Successful", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                            else{
                                int a = Ship_Area.temp_counter;
                                if(a>=0) {
                                    ...
                                    Toast.makeText(Scanner_In_Ship_Area.this, "Scan Success!", Toast.LENGTH_SHORT).show();
                                    ...
                                    a++;
                                    Toast.makeText(Scanner_In_Ship_Area.this, "No People to sign out!!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
