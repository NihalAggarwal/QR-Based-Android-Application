...
public class ScannerOut extends AppCompatActivity {
                        ...
                        try {
                            ...
                            if (decrypt.equals(compare)) {
                                ...
                                if (a >= 0) {
                                    ...
                                    Toast.makeText(ScannerOut.this, decrypt, Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(ScannerOut.this, "No People to sign out!!", Toast.LENGTH_SHORT).show();
                                }

                                Dormitory.counter.setText(Integer.toString(a));
                                Toast.makeText(ScannerOut.this, "Scan Successful", Toast.LENGTH_SHORT).show();
                                finish();
                            } else {
                                int a = Dormitory.temp_counter;


                                Toast.makeText(ScannerOut.this, "Logged Out Success!", Toast.LENGTH_SHORT).show();
                                DatabaseReference referenceout = FirebaseDatabase.getInstance().getReference("User");
                                ...
                                referenceout.child(decrypt).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<DataSnapshot> task) {
                                        ...
                                        ref = database.getInstance().getReference().child("Dormitory").child(PhoneNo);
                                        ref.removeValue();
    ...
    private void deleteItemToSheet(String PhoneNo) {
        ...
        StringRequest stringRequestOut = new StringRequest(Request.Method.POST, url, response -> {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                paramsOut.put("action", "deleteItem");
    ...
    private void displayCount(int a){
